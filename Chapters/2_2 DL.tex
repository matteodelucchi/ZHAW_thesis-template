...
What is often referred to as fully connected, dense, or feed-forward neural network describes a network consisting of solely densely connected layers. These layers are connected in an $n:m$ manner, where each node of layer with $n$ nodes is connected with each node of layer with $m$ nodes. 
